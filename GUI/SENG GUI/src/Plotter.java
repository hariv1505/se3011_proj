...
//place all point
     ...
     for (int i = 0; i < curvePoints.length; i++) {
         ...
         drawwidth[i] = (int) (80+(580/(maxtime-mintime)*(i))) ;
         avgwidth[i] = (int) (80+(580/(maxtime-mintime)*(i))) ;
    ...
    //     System.out.println(avgHigh[i]);
     ...
     for (int i = 0; i < 10; i++) {    	   
  	   ...
  	   g.drawString(arr[1], 80 + i * 60, 620);
     }
  // draw lines
     ...
     for (int i = 540; i > 0; i -= 38) {
         ...
         g.drawLine(80, (i + 60), 650, (i + 60));
         j++;
     }
     g.setColor(Color.BLACK);
     g.drawLine(80, 40, 80, 600);
     g.drawLine(80, 600, 650, 600);
     ...
     g.drawString(xCoordinate, 650, 640);
  }
